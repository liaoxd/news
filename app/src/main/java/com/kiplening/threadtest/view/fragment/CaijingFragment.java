 ...
 */
public class CaijingFragment extends Fragment implements fragmentPresenter {
...
//        adapter.notifyDataSetChanged();
    ...
    @Override
    public void onFinish(List<NewsBean> data) {
        adapter = new MyAdapter(getActivity(),data);
        listView.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        System.out.println("超级搞笑");
    }
